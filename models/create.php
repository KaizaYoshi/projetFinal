...
if (count($problems) > 1):
    ...
    $req = $bdd->prepare('INSERT INTO `pokemon_users` (ID_user, name_ID, ability_ID, move1_ID, move2_ID, move3_ID, 
move4_ID, nature_ID, item_ID, ball_ID, iv1, iv2, iv3, iv4, iv5, iv6, ev1, ev2, ev3, ev4, ev5, ev6) VALUES(:user, :name, 
:ability, :move1, :move2, :move3, :move4, :nature, :item, :ball, :iv1, :iv2, :iv3, :iv4, :iv5, :iv6, :ev1, :ev2, :ev3, 
:ev4, :ev5, :ev6)');
    $req->execute(array(
        'user' => $_SESSION["id"],
        'name' => $_POST["name"],
